...
class ActualizarUsuarioVentana:
    def __init__(self, controlador = None):
        ...
        self.boton = tk.Button(self.root, text="Guardar", command=self.actualizarPersona)
        self.boton.pack()
    ...
    def actualizarPersona(self) -> None:
        try:
            persona = UserVO(
            ...
            self.coordinador.actualizarUsuario(persona)
            self.limpiar()
