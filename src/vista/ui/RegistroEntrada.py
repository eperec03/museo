...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.enviarBoton.setGeometry(QRect(810, 600, 141, 51))
        palette = QPalette()
...
"background-color: rgb(208, 223, 232);")
        ...
        self.label_3.setGeometry(QRect(660, 150, 451, 91))
